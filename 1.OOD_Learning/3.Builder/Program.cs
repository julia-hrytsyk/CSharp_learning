...
///Builder interface defines the steps to build the final object. This 
///builder is independent from the objects creation process. A class that
///is known as Director, controls the object creation process.
///Moreover, builder pattern describes a way to separate an object from its
